    ...
    <div className="scroll-parent">
      <section id="section1" style={{ height: '100vh' }} className="flex justify-center items-center">
        <div className="size-3/4 flex flex-col justify-center gap-2">
          <h1 className="text-lg md:text-xl lg:text-2xl text-center">Hi. I'm <span className="text-red-500">Hamza</span></h1>
      ...
      <section id="section2" style={{ height: '100vh' }} className="flex flex-col justify-center items-center">
        <h1 className="text-md sm:text-lg md:text-2xl pl-8 font-medium text-center md:p-10">My Tech Stack</h1>
      ...
      <section id="section3" className="flex justify-center h-auto" style={{ minHeight: '100vh' }}>
        <div className="w-3/4 md:w-full h-full">
          <h1 className="text-md sm:text-2xl p-6 md:p-8 text-center font-medium">Projects</h1>
